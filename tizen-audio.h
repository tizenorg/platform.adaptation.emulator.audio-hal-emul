 ...
 *
 * @remarks Some audio hal implementation do not need this message callback.\n
 * In these cases, @c message_cb, @c audio_add_message_cb and @c audio_remove_message_cb symbols could be removed.
 *
...
/**
 * @brief Adds the message callback function when audio hal implementation needs to send a message.
 * @since_tizen 3.0
 * @param[in] audio_handle The audio hal handle
